...
public class ImaPlayer {
    ...
    public ImaPlayer(Activity activity,
                     ...
                     ExoplayerWrapper.PlaybackListener uiListener,
                     String adTagUrl,
        ...
        contentPlayer.addPlaybackListener(uiListener);
    ...
    public ImaPlayer(Activity activity,
                     ...
                     ExoplayerWrapper.PlaybackListener uiListener,
                     String adTagUrl) {
        this(activity, container, video, videoTitle, sdkSettings,uiListener, adTagUrl, null);
    }
